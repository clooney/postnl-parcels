PostNL Tracking API - Python
================================
Use Python to track PostNL shipments with PostNL Tracking API.
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': 'AP128385825NL,RE170227208NL', 'courier_code': 'postnl-parcels'}
