PostNL Tracking API - Java
================================
Use Java to track PostNL shipments with PostNL Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.postnlparcels;
    ...
    public class CreatePostNLTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("RE170227208NL");
                createTrackingParams.setCourierCode("postnl-parcels");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreatePostNLTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("RU993554066NL");
                createTrackingParams1.setCourierCode("postnl-parcels");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("AP128385825NL");
                createTrackingParams2.setCourierCode("postnl-parcels");
...
Get status of the shipment:
    ...
    public class GetPostNLTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("RU993554066NL,AP128385825NL");
                trackingParams.setCourierCode("postnl-parcels");
...
Update a tracking by ID:
    ...
    public class UpdatePostNLTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9d8a3856180b591b1ceb6213419519a7";
