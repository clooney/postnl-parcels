PostNL Tracking API - .Net
================================
Use .Net to track PostNL shipments with PostNL Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "RE170227208NL";
                  createTrackingParams.courierCode = "postnl-parcels";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "RU993554066NL,AP128385825NL";
                  getTrackingResultsParams.courierCode = "postnl-parcels";
